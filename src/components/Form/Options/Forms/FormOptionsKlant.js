...
class FormKlant extends Component {
  ...
  handleSubmit = e => {
    e.preventDefault();
    this.props.onFormSubmit(this.state, 'lead')
    this.setState({
      messageVisible: true
    })
  }
    ...
    return (
      <div>
        <PositiveMessage visible={messageVisible} onClose={this.close} >
          <span>Lead created with success!</span>
        ...
        <Form className='form-border' 
          ...
          <Form.Group widths='equal'>
            ...
            <Form.Input required fluid label='Postcode' placeholder='Postcode' onChange= { e => this.handleInput('zip', e) }/>
