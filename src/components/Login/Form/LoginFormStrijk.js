...
import { strijkOffices } from '../../db/dboffices'
import NegativeMessage from '../../Layout/Message/NegativeMessage'

const officeList = strijkOffices.map(o  => ({ value: o.name, key: o.key, text: o.name })).sort()
...
const LoginFormStrijk = ({ onFormSubmit }) => {
  ...
  return(
    <>
      ...
      <StyledForm onSubmit={firstValidation}>
        <StyledIdentifier>Strijk Login</StyledIdentifier>
        <StyledSelect
            fluid
...
export default LoginFormStrijk;
